		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Initial Letter For Goods And Supply",
									"targetURL": "#comkpoinitialletterforgoods-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkpoinitialletterforgoods-display": {
								"semanticObject": "comkpoinitialletterforgoods",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.initialletterforgoods",
									"url": sap.ui.require.toUrl("com/kpo/initialletterforgoods")
								}
							}
						}
					}
